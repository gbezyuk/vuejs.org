...
A probably more important distinction is that Vue is intentionally designed to be incrementally adoptable, and thus seems to be easier for existing apps to migrate.
